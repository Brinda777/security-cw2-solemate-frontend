    ...
    return (
        <div className='navbar'>
            <Link to='/' onClick={() => { setMenu("shop") }} className="nav-logo">
                <img src={'/Assets/WALK-WISE-WEB.png'} alt="Logo" />
            </Link>

            <img onClick={() => menuRef.current.classList.toggle('nav-menu-visible')} className='nav-dropdown' src={'Assets/nav_dropdown.png'} alt="Dropdown" />
                        ...
                        <div className="nav-user-dropdown" ref={dropdownRef}>
                            ...
                            {dropdownOpen && (
                                <div className="nav-dropdown-menu">
                                    ...
                                    {user.isAdmin === true ? <Link to='/admin/dashboard'>Admin Dashboard</Link> : null}
